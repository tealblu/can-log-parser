...
CONFIG = {
    ...
    # Log file paths
    'log_directory': 'logs',
    'log_filename': 'kvaser.txt',
    'full_log_path': lambda: f"{CONFIG['log_directory']}/{CONFIG['log_filename']}",
    
    # Command timing (seconds relative to log start)
    'command_fire_times': [60, 73, 79, 88, 101, 111, 119, 127, 133, 141, 148, 155, 167, 175],
    'log_start_time': 0.0,
    'routine_start_time': 60,  # Optional; leave None if not needed
...
class CANDataPatternAnalyzer:
    ...
    def find_command_candidates(
        ...
        Args:
            ...
            expected_occurrence_count: If provided, only consider patterns that occur exactly this many times.
